...
\caption{Continuum \(\Phi(\zeta)=-\log\Fid(\rho_{ABC},\tilde\rho_{ABC})\) at large cross ratio: rigorous lower bounds and uncertified extrapolated estimates (\(a=1\), \(L=2\), \(\zeta=s/3\); box \(\Lambda=120\), \(\kappa_{\max}=45\)). \(\Phi^{\rm sub}\) in the spectral window \(\eps<w<1-\eps\), \(\kappa_c=\log(1/\eps)\), is a rigorous lower bound; the small-\(\zeta\) tail \(\zeta^2/(15\kappa_c^2)\) is NOT valid here. \(\Phi_\infty\) is the \(\kappa_c\to\infty\) extrapolation \(\Phi^{\rm sub}=\Phi_\infty-b\,\kappa_c^{-p}\) (\(p\) free), an estimate and not a bound; the bracket is \([\Phi^{\rm sub}(\kappa_c^{\max}),\Phi_\infty]\). Last columns: local log-slope and the lattice value (O7a, \(c=1\) hopping chain) interpolated at the same \(\zeta\).}\label{tab:largezeta}
