...
{\sloppy
This correction implements the knowledge-base card \texttt{km-exact-identity} (project
\texttt{cft\_cmi}), whose refereed Statement is the specification.  The changed line was replaced by
