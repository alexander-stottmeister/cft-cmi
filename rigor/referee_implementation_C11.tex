...
\cA(S^1)$, which for an irreducible net is $\mathbb C\mathbf 1$; that route needs $Z_t\in\cA(S^1)=B(\Hil)$ and
...
$Z_t\in\cA(S^1)'=\mathbb C\mathbf 1$ as soon as $Z_t$ commutes with every local algebra, and $Z_t$ does commute with
