...
| rate_of_remainder.tex | 20 | RR (Phase 2b): global bound Phi <= -(1/2)log(1-2 f_2 zeta^2) UNCONDITIONAL (group extension, PA Prop 7.6), c_3 = -0.99(1), log^-2 claim refuted; refereed by RRr, repairs applied (§6.2-6.4) |
