...
## Build status
- All 18 standalone rigor documents compile (build_all.sh, log build_all_2026-09-05.log); the two macro clashes found by the full rebuild (\cB etc. in audit_dependencies.tex, check_note4.tex) were fixed.
