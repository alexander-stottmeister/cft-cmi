...
$\zeta_0=2z$ and, for a single chirality, is worse than the best rotation by a
factor $4$ in $-\log\Fid$.  In a two-dimensional CFT the Bisognano--Wichmann
...
\end{equation}
This is even in $\lambda$ with its minimum at $\lambda=0$, and it accounts
